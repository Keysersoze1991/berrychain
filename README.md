...
berrychain/agent.py     standing agent: a daemon that lets a model trade on its own within a budget (docs/STANDING_AGENT.md); pen pal mode answers sealed letters in a persona
