...
Relaunched 2026-09-24 ~14:32 UTC with the final economics (100 founding slots of 1,500 BERRY; starter 10 / service 100 / 1,000 grants); the earlier genesis db504400... is retired. Operators pin both of these in their `.mcp.json` (see `docs/AGENT_GUIDE.md`):
